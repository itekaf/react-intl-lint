...
describe('Core Integration', () => {
    ...
    describe('Custom RegExp to find keys', () => {
       it('should be find keys', () => {
           ...
           // Act
           const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesWithMaskPath, undefined, errorConfig);
    ...
    describe('Empty Keys', () => {
        it('should be warning by default', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesWithMaskPath);
            const result: ResultCliModel = model.lint();
    ...
    describe('Misprint', () => {
        ...
        it('should be error', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesWithMaskPath,  '', errorConfig);
            const result: ResultCliModel = model.lint();
        ...
        it('should be have 2 or more suggestions for one key', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesWithMaskPath, ignorePath, errorConfig);
            const result: ResultCliModel = model.lint();
    ...
    describe('Ignore', () => {
        ...
        it('should be empty or incorrect', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesWithMaskPath, ignorePath);
            const result: ResultCliModel = model.lint();
    ...
    describe('Path', () => {
        it('should be relative and absolute', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(absolutePathProject, languagesWithMaskPath);
            const result: ResultCliModel = model.lint();
        ...
        it('should be absent mask', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectAbsentMaskPath, languagesAbsentMaskPath, ignorePath, errorConfig);
            const result: ResultCliModel = model.lint();
        ...
        it('should be empty and incorrect', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(emptyFolder, incorrectFolder);
        ...
        it('should with parse error', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesIncorrectFile);
    ...
    describe('Config', () => {
        ...
        it('should be incorrect', () => {
            ...
            // Act
            const model: ReactIntlLint = new ReactIntlLint(projectWithMaskPath, languagesWithMaskPath, ignorePath, errorConfig as IRulesConfig);
    ...
    it('with full arguments', () => {
        ...
        // Act
        const model: ReactIntlLint = new ReactIntlLint(absolutePathProject, languagesWithMaskPath, ignorePath, errorConfig);
        const result: ResultCliModel = model.lint();
